...
# django_overtuned/
APPS_DIR = BASE_DIR / "django_overtuned"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "django_overtuned.contrib.sites.migrations"}
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "django_overtuned.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "django_overtuned.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "django_overtuned.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "django_overtuned.users.forms.UserSocialSignupForm"}
...
HEADLESS_FRONTEND_URLS = {
    ...
    #
    # "{FRONTEND_BASE_URL}/account/email/verify-email?token={key}",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Django Overtuned API",
    "DESCRIPTION": "Documentation of API endpoints of Django Overtuned",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
    "SCHEMA_PATH_PREFIX": "/api/",
    "EXTERNAL_DOCS": {
        "description": "authentication",
        "url": "/api/auth/openapi.html",
    },
}
# Your stuff...
# ------------------------------------------------------------------------------
